...
**WO12 complete (2026-06-26).** L8 buffer experiment done: `areal_signature` at level=8, Timbuktu 100 km. Band T invariant confirmed (321 rows, delta=0). 11/11 modality flips two_regime→unimodal; only dist_sink survives. 4 coherence flips, no directional bias. Outlet_type sub-class structure (endo inland vs terminal sink) visible only at L8. AF.6–AF.10 written.
