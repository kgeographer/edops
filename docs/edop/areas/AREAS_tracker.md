...
Engine **assembled and whole**; neighborhood work underway. **WO12** (L8 buffer MAUP), **WO14** (single-basin, v0.3 comparison), **WO15** (area-weighted cell weighting), **WO16** (basin-ring spatial exploration), **WO17** (basin-ring resolver + per-neighbor transition diagnostic, 3 fixtures), and **WO18** (transition-character comparator, spanning-10, gate PASS) are all done. Branch: `engine_v0.4b`.
...
**Next:** WO19 — scaled run (~50 WHC cities), anchoring + stability + cultural probe. See `docs/edop/engine/wo19_comparator_n50.md`.
