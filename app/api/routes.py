...
from app.api.routes_common import _load_variables, _HYDE_SAFE_VARS
...
# /explorer/values moved to routes_common.py (2026-08-16, routes split) —
# shared by sandbox.html, explorer.html, and cliopatria.html.
