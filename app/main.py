...
app = FastAPI(
    ...
    description="A component of [Computing Place](https://computingplace.org).\n\n[API Guide](https://edops.computingplace.org/docs/api/) · [Variable catalog](https://edops.computingplace.org/documentation/EDOPS_variable_catalog_v0.4.tsv) · [Schema](https://edops.computingplace.org/documentation/edops_schema.json)",
    version="0.4"
)
