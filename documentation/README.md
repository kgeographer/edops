...
| `API_guide.md` | Superseded 2026-08-16 by the generated API Guide at `docsite/api.md` (served at `/docs/api/`) — kept only until the retirement pass (deleting this file and its `/static/api_guide.html` twin) is confirmed safe. Do not edit; edit `docsite/api.md` or its generator, `scripts/edop/docsite/generate_api_guide.py`. |
